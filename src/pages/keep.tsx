  ...
  return (
    <div className="container-div box-border z-20  w-full overflow-hidden bg-[#e7e2dc]">
      ...
      <div className="h-auto lg:h-screen w-full pt-16 m-0">
        <div className="w-full h-full grid grid-cols-1 lg:grid-cols-2 grid-rows-4 lg:grid-rows-2 p-0 m-0">

          <Link to={'project-deck-consultation'} className="m-0 p-0">
            <div className="h-full min-h-[60vh] w-full p-0 m-0">
              <div className="bg-[url('/images/work-2.png')] hover:bg-[url('/images/work-1.jpg')] bg-cover bg-center hover:bg-center bg-no-repeat h-full w-full flex flex-col items-center justify-center duration-500">
